...
import com.qualitybazar.service.ReviewService;
...
public class ReviewController {
	...
	public ResponseEntity<List<Review>>getProductsReviews(@PathVariable Long productId)throws UserException,ProductException{
