...
public class Order {
	...
	public Order(Long id, String orderId, User user, List<OrderItem> orderItems, LocalDateTime orderDate,
			...
			Integer totalDiscountedPrice, Integer disocunte, String orderStatus, int totalItem,
	...
	public Integer getDisocunte() {
		return disocunte;
	}

	public void setDisocunte(Integer disocunte) {
		this.disocunte = disocunte;
	}
